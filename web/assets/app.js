...
const I18N={
  fr:{
    ...
    modelLi3:"<b>Créer un intent réserve l'Available</b> → empiler les tranches fait <b>baisser le L restant</b> → le frais % monte le long d'une <b>surface mesurée</b> <code>fee%(montant, L)</code> (mesures historiques en drainage réel — distinctes du balayage de la page Doc, qui ne sert qu'au graphe), <b>plafonnée à 0,50 %</b>.",
  ...
  en:{
    ...
    modelLi3:"<b>Creating an intent reserves the Available</b> → stacking chunks <b>lowers remaining L</b> → the fee% climbs along a <b>measured surface</b> <code>fee%(amount, L)</code> (historical real-drain measurements — distinct from the Doc page's sweep, which only feeds the chart), <b>capped at 0.50%</b>.",
...
function simul(){
  ...
  for(let n=1;n<=splitMax;n++){
    ...
    for(let i=0;i<n;i++){
      ...
      const ratio=(s0>0)?surfPct(dk,c,L0-reserved)/s0:1;             // forme d'escalade (surface mesurée), sans dimension
