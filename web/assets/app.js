...
function renderReco(best,dk,T,sel){
  ...
  // refill advice: fee of the selected band > 0.25% = low hub → waiting for the refill lowers it. Guard recv≥100: below this amount the high % comes from the €0.01 floor, not from draining (waiting wouldn't help). The 0.25% threshold is a maintainer's choice, not a measurement.
